// Author: Wendy Huang
// Date: 11/10/2023
// Description: Server setup for the website. This includes user authentication, product handling, and admin functionalities.
...
app.use(session({
    ...
    cookie: { maxAge: 24 * 60 * 60 * 1000 } // 24-hour cookie expiry
}));

// Global Variables and Utility Functions
const loggedInUsers = {};
const all_products = require(__dirname + '/products.json');
const user_registration_info = JSON.parse(fs.readFileSync(__dirname + "/user_registration_info.json", "utf-8"));
